...
import { StyleSheet, View, useWindowDimensions, FlatList, Button, Text, TextInput, TouchableOpacity } from 'react-native';
import { TabView, SceneMap, TabBar } from 'react-native-tab-view';
import GridWinList from "../component/GridWinList";
...
const SecondRoute = (props) => {
  ...
  const handleDeleteItem = (index) => {
    const updatedPriceList = [...editedPriceList];
    updatedPriceList.splice(index, 1); // Remove the item 
    ...
    // Set  editedPriceList with the item removed
    setEditedPriceList(updatedPriceList);
};
